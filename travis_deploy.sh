...
git config --global user.name "pkuhollow"
git config --global user.email "pkuhollow@protonmail.com"
git remote rm origin
git remote add origin https://pkuhollow:"${GH_TOKEN}"@github.com/pkuhollow/webhole.git
